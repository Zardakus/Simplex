...
//	caso queira usar o exemplo pronto, é só comentar a linha 25 e descomentar da linha 16 a 23
	
    public static void main(String[] args) {
    	
    	double[][] Restricao = { { -3, 1, 1 }, 
		 						 { 4, 2, 20 },  
		 						 { 4, -1, 10 }, 
		 						 { -1, 2, 5 } };
		double[] func = { 2, 3 };
		maximizacao = true;
		preencherVariaveis(2, 4);
		montarMatriz(2, 4, Restricao, func, maximizacao);
